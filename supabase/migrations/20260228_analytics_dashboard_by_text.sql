-- Add analytics breakdown by text to dashboard RPC.
-- events_by_text: event count per text_id.
-- events_over_time_by_text: daily event count per text_id (30 days) for time-series chart.
