...
final List<StudyTextConfig> studyTextRegistry = [
  const StudyTextConfig(
    ...
    parsedJsonPath: 'texts/bcv_parsed.json',
    hierarchyPath: 'texts/verse_hierarchy_map.json',
    commentaryPath: 'texts/verse_commentary_mapping.txt',
    sectionCluesPath: 'texts/section_clues.json',
    quizBeginnerPath: 'texts/root_text_quiz.txt',
    quizAdvancedPath: 'texts/root_text_quiz_400.txt',
