# Empty Leaf Nodes Audit

Leaf nodes in `verse_hierarchy_map.json` that have no verses assigned.
...
| 4.6.2.5.1.1.1 | The non-establishment of the eight worldly dharmas, the objects of attachment |
